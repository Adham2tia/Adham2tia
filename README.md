...
- 🎓 Computer Science & AI Student at Fayoum University.
- 📊 Aspiring Data Analyst with a strong interest in Business Intelligence and Data Visualization.
- 📈 Skilled in building interactive dashboards using **Power BI** and **Microsoft Excel**.
- 📊 Familiar with **Tableau** for creating interactive dashboards and visualizations.
- 🗄️ Intermediate in **SQL** for data querying and analysis.
